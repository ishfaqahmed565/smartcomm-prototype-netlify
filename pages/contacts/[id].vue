<script lang="ts">
	...
	export default defineComponent({
		setup() {
			...
			return { id, showTimeline, showTickets, showNotes, showEditModal };
		},
	});
	definePageMeta({
		layout: false,
...
<template>
	<NuxtLayout name="default">
		<template #title>Contacts > {{ id }} </template>
		<!--Page layout title -->
		<template #secondbar
			><div class="second-bar">
				...
				<div class="second-bar__section"><PagButton /></div></div
		></template>
		...
		<div class="flex gap-3">
			<div class="w-10/12 space-y-2">
				<div>
					<div class="flex justify-between feature-container rounded-b-none">
						<div class="flex gap-5">
							...
							/>
							<h3 class="info-header">Ashiq Zaman</h3>
						</div>
						<NavButton class="h-fit">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
				...
				<div class="space-y-4" v-if="showTimeline">
					<div
				...
				<div class="feature-container" v-if="showNotes"></div>
			</div>
			<div class="w-2/12 space-y-2">
				...
				<SideStickyDrop>
					...
					<template #drop-data>
						<div class="p-2 flex items-center ticket-info__main-section gap-2">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
		...
		<Teleport to="body">
			<EditModal :showEditModal="showEditModal" @close="showEditModal = false">
				<div>
