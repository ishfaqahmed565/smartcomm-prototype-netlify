			...
			<div class="p-3 flex justify-between w-full items-center">
				...
				>
					...
					<div @click="checked2 = false">
						<el-checkbox v-model="checked" size="mini" border
							>Ascending</el-checkbox
						>
					</div>
					<div @click="checked = false">
						<el-checkbox v-model="checked2" size="mini" border
				...
				<div class="flex gap-3 items-center">
					...
					<div class="flex">
						...
						<NavButton class="rounded-r-md rounded-l-none">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
